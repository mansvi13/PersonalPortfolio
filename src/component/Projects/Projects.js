    ...
    return(
        <div className='p-wrapper'id='Projects'>
            <div className ='p-project'>
                ...
                <p className="p-idfdetails" style={{ color: 'white',width:'40%',marginLeft:'57%',marginTop:'-20%',fontFamily:"verdana",fontSize:'110%'}}>Intelligent Document Finder(IDF) is a NLP based document search engine.<br/>
                    ...
                    addition of manual keywords,which will make the user experience more easy to find the document from the machine just by searching <br/>
                ...
                <p style={{color:'white' ,width:'40%',marginLeft:'57%',marginTop:'-15%',fontFamily:"verdana",fontSize:'110%'}}>Built a basic audio streaming app using HTML,CSS,Javascript. <br/>
                ...
                <p style={{color: 'white',width:'40%',marginLeft:'57%',marginTop:'-23%',fontFamily:"verdana",fontSize:'110%'}}>Built an application where user can easily get the transcripts of the youtube videos and can  <br/>
